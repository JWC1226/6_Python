...
# TODO: 0 ~ 11까지 데이터를 포함하는 1 차원 배열 생성
arr = np.arange(12)
print(f"arr: {arr}")

# 1 차원 배열(12,)을 2차원 배열(3, 4)로 재구성
...
# ravel 이 복사본을 반환하는 경우
    ...
    # .base 속성으로 뷰인지 복사본인지 확인이 가능하다 !
        # Ex) arr_1d_2.base is arr_3d > True (메모리를 참조한다 ≒ 뷰) / False (복사본)
