...
print(f"{message[7:]}")
print(f"{message[::2]}")  # 2칸 간격으로 슬라이싱 처리
print(f"{message[::-1]}") # -1, 역순으로 슬라이싱 처리
