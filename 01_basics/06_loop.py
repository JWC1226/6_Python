...
# range(시작, 끝, 간격)
print(f"range(5) > {list(range(5))}")           # 끝 값을 5로 지정 / 시작: 0、간격: 1
print(f"range(1, 6) > {list(range(1, 6))}")     # 시작 값을 1로 지정、끝 값을 6으로 지정 / 간격: 1

# [0, 2, 4, 6, 8] (짝수) > 시작: 0 / 간격: 2 / 끝: 10
...
print("=" * 60)
print("zip() - 여러 리스트를 동시에 사용하는 함수")
print("=" * 60)

names = ["삼성전자", "SK 하이닉스", "카카오"]
...
# for-else : 반복문 정상 종료 시, else 블록을 실행시켜주는 문법
print(f"{members}")
for m in members:
    if m == "사용자":
        print("찾았습니다!")
